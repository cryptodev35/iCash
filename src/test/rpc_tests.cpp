...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(write_string(ValueFromAmount(2055555555555590LL), false) == "20555599.55559990");
    BOOST_CHECK(write_string(ValueFromAmount(2055555555555599LL), false) == "20555599.55555555");
}
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK(AmountFromValue(ValueFromString("20555599.5555999")) == 2055555555555590LL);
    BOOST_CHECK(AmountFromValue(ValueFromString("20555599.55555555")) == 2055555555555599LL);
}
